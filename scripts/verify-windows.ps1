...
try {
    if (-not $ProofsOnly) {
        ...
        try {
            foreach ($features in @('', 'msi-proof-device', 'exception-smoke-test', 'exception-smoke-test,double-fault-smoke-test', 'ap-double-fault-smoke-test', 'ap-scheduler-smoke-test', 'ahci-write-smoke-test', 'fat-write-smoke-test')) {
