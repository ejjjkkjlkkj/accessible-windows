...
try {
    ...
    $markers = @('AW_BOOT_OK stage=uefi_init arch=x86_64','AW_KERNEL_FILE_READ_OK','AW_KERNEL_IMAGE_HEADER_OK','AW_NATIVE_KERNEL_LOAD_OK','mode=fixed_base','AW_MEMORY_MAP_OK','AW_ACPI_OK','AW_ACPI_VALIDATE_OK','AW_GOP_OK','AW_FRAMEBUFFER_OK','AW_EXIT_BOOT_SERVICES_OK','AW_MEMORY_MAP_HANDOFF_OK','AW_KERNEL_HANDOFF_OK','AW_NATIVE_KERNEL_TRANSFER','AW_GDT_SEGMENTS_RELOADED cs=0x0000000000000008 ss=0x0000000000000010','AW_NATIVE_KERNEL_ENTRY_OK','AW_VMM_ACTIVE','AW_APIC_TIMER_FIRED','AW_MEMORY_MAP_VALIDATE_OK','AW_MEMORY_MAP_CONVENTIONAL_OK','AW_BOOTSTRAP_PAGE_ALLOC_OK','AW_CPU_NX_OK','AW_CPU_ADDRESS_WIDTH_OK physical=','AW_PAGING_BASELINE_OK','AW_NATIVE_FRAMEBUFFER_WRITE_OK','AW_NATIVE_KERNEL_IDLE')
