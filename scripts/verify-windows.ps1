...
try {
    if (-not $ProofsOnly) {
        ...
        try {
            foreach ($features in @('', 'msi-proof-device', 'exception-smoke-test', 'exception-smoke-test,double-fault-smoke-test', 'ap-double-fault-smoke-test', 'ap-scheduler-smoke-test')) {
