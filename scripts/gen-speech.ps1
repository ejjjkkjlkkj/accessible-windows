...
$phrases = [ordered]@{
    ...
    'setup_intro'                = 'Accessible Windows firmware setup'
    'setup_main'                 = 'Main'
    ...
    'setup_architecture_x64'     = 'Architecture x86 64'
    'setup_virtualization'       = 'Virtualization capability'
    'setup_boot_priorities'      = 'Boot option priorities'
    'setup_current_boot'         = 'Current boot option'
    'setup_boot_order'           = 'Boot order'
    'setup_secure_boot'          = 'Secure Boot'
    'setup_secure_boot_state'    = 'Secure Boot state'
    'setup_setup_mode'           = 'Setup mode'
    'setup_boot_normally'        = 'Boot normally'
    'setup_enter_firmware'       = 'Enter firmware setup'
    'setup_restart'              = 'Restart'
    'setup_shutdown'             = 'Shut down'
