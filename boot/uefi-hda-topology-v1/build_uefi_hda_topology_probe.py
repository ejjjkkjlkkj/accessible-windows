...
MARKS={
 'start': b'QEVARYNOX-UEFI-HDA-TOPOLOGY-V1\r\nSTATE=START\r\nMODE=AUTO_DIRECT_ROUTE\r\nTRANSPORT=IMMEDIATE_COMMAND\r\nEND\r\n',
 'hda': b'QEVARYNOX-UEFI-HDA-TOPOLOGY-V1\r\nHDA_CONTROLLER_CODEC=PASS\r\nEND\r\n',
 'vendor': b'QEVARYNOX-UEFI-HDA-TOPOLOGY-V1\r\nGET_PARAMETER_VENDOR_ID=PASS\r\nVENDOR_AGNOSTIC=PASS\r\nEND\r\n',
 'nodes': b'QEVARYNOX-UEFI-HDA-TOPOLOGY-V1\r\nROOT_SUBORDINATE_NODES=PASS\r\nEND\r\n',
 'afg': b'QEVARYNOX-UEFI-HDA-TOPOLOGY-V1\r\nAUDIO_FUNCTION_GROUP=PASS\r\nAFG_SUBORDINATE_WIDGETS=PASS\r\nEND\r\n',
 'widgets': b'QEVARYNOX-UEFI-HDA-TOPOLOGY-V1\r\nAUTO_DAC_WIDGET=PASS\r\nAUTO_OUTPUT_PIN_WIDGET=PASS\r\nPIN_OUTPUT_CAP=PASS\r\nEND\r\n',
 'route': b'QEVARYNOX-UEFI-HDA-TOPOLOGY-V1\r\nPIN_CONNECTION_LIST=PASS\r\nAUTO_PIN_TO_DAC_DIRECT_ROUTE=PASS\r\nNO_FIXED_WIDGET_NIDS=PASS\r\nEND\r\n',
 'done': b'QEVARYNOX-UEFI-HDA-TOPOLOGY-V1\r\nSTATUS=PASS\r\nEND\r\n',
 'no_hda': b'QEVARYNOX-UEFI-HDA-TOPOLOGY-V1\r\nSTATUS=BLOCKED\r\nREASON=HDA_PCI_NOT_FOUND\r\nEND\r\n',
 'bad_hda': b'QEVARYNOX-UEFI-HDA-TOPOLOGY-V1\r\nSTATUS=BLOCKED\r\nREASON=HDA_CONTROLLER_OR_CODEC_FAILED\r\nEND\r\n',
 'verb_timeout': b'QEVARYNOX-UEFI-HDA-TOPOLOGY-V1\r\nSTATUS=BLOCKED\r\nREASON=IMMEDIATE_COMMAND_TIMEOUT\r\nEND\r\n',
 'vendor_fail': b'QEVARYNOX-UEFI-HDA-TOPOLOGY-V1\r\nSTATUS=BLOCKED\r\nREASON=CODEC_VENDOR_INVALID\r\nEND\r\n',
 'nodes_fail': b'QEVARYNOX-UEFI-HDA-TOPOLOGY-V1\r\nSTATUS=BLOCKED\r\nREASON=SUBORDINATE_NODES_INVALID\r\nEND\r\n',
 'afg_fail': b'QEVARYNOX-UEFI-HDA-TOPOLOGY-V1\r\nSTATUS=BLOCKED\r\nREASON=AUDIO_FUNCTION_GROUP_NOT_FOUND\r\nEND\r\n',
 'widget_fail': b'QEVARYNOX-UEFI-HDA-TOPOLOGY-V1\r\nSTATUS=BLOCKED\r\nREASON=AUTO_OUTPUT_WIDGETS_NOT_FOUND\r\nEND\r\n',
 'route_fail': b'QEVARYNOX-UEFI-HDA-TOPOLOGY-V1\r\nSTATUS=BLOCKED\r\nREASON=DIRECT_OUTPUT_ROUTE_NOT_FOUND\r\nEND\r\n',
}
...
def main():
 if len(sys.argv)!=2: raise SystemExit('usage: build_uefi_hda_topology_probe.py OUTPUT_EFI')
 image=build(); validate(image); p=Path(sys.argv[1]); p.parent.mkdir(parents=True,exist_ok=True); p.write_bytes(image)
 print('OS_UEFI_HDA_TOPOLOGY_PROBE_BUILD=PASS'); print('bytes='+str(len(image))); print('sha256='+hashlib.sha256(image).hexdigest())
