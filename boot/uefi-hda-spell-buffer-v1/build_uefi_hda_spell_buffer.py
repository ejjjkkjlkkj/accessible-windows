...
MARKS={
 'start': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nSTATE=START\r\nSYNTH=ALLOPHONE_BDL_RUNTIME_V1\r\nMODE=RUNTIME_SPELL_BUFFER_AUTOROUTE\r\nTRANSPORT=HDA_NATIVE_DMA\r\nEND\r\n',
 'wait': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nEVENT=WAIT_SPELL_BUFFER\r\nSUPPORTED=A-Z,a-z\r\nMAX_GRAPHEMES=8\r\nENTER=COMMIT\r\nEND\r\n',
 'char_a': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nEVENT=GRAPHEME\r\nCHAR=a\r\nUNITS=a\r\nEND\r\n',
 'char_b': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nEVENT=GRAPHEME\r\nCHAR=b\r\nUNITS=b,e\r\nEND\r\n',
 'char_c': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nEVENT=GRAPHEME\r\nCHAR=c\r\nUNITS=s,e\r\nEND\r\n',
 'char_d': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nEVENT=GRAPHEME\r\nCHAR=d\r\nUNITS=d,e\r\nEND\r\n',
 'char_e': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nEVENT=GRAPHEME\r\nCHAR=e\r\nUNITS=e\r\nEND\r\n',
 'char_f': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nEVENT=GRAPHEME\r\nCHAR=f\r\nUNITS=e,f\r\nEND\r\n',
 'char_g': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nEVENT=GRAPHEME\r\nCHAR=g\r\nUNITS=sh,e\r\nEND\r\n',
 'char_h': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nEVENT=GRAPHEME\r\nCHAR=h\r\nUNITS=a,sh\r\nEND\r\n',
 'char_i': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nEVENT=GRAPHEME\r\nCHAR=i\r\nUNITS=i\r\nEND\r\n',
 'char_j': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nEVENT=GRAPHEME\r\nCHAR=j\r\nUNITS=sh,i\r\nEND\r\n',
 'char_k': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nEVENT=GRAPHEME\r\nCHAR=k\r\nUNITS=k,a\r\nEND\r\n',
 'char_l': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nEVENT=GRAPHEME\r\nCHAR=l\r\nUNITS=e,l\r\nEND\r\n',
 'char_m': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nEVENT=GRAPHEME\r\nCHAR=m\r\nUNITS=e,m\r\nEND\r\n',
 'char_n': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nEVENT=GRAPHEME\r\nCHAR=n\r\nUNITS=e,n\r\nEND\r\n',
 'char_o': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nEVENT=GRAPHEME\r\nCHAR=o\r\nUNITS=o\r\nEND\r\n',
 'char_p': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nEVENT=GRAPHEME\r\nCHAR=p\r\nUNITS=p,e\r\nEND\r\n',
 'char_q': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nEVENT=GRAPHEME\r\nCHAR=q\r\nUNITS=k,u\r\nEND\r\n',
 'char_r': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nEVENT=GRAPHEME\r\nCHAR=r\r\nUNITS=e,r\r\nEND\r\n',
 'char_s': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nEVENT=GRAPHEME\r\nCHAR=s\r\nUNITS=e,s\r\nEND\r\n',
 'char_t': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nEVENT=GRAPHEME\r\nCHAR=t\r\nUNITS=t,e\r\nEND\r\n',
 'char_u': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nEVENT=GRAPHEME\r\nCHAR=u\r\nUNITS=u\r\nEND\r\n',
 'char_v': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nEVENT=GRAPHEME\r\nCHAR=v\r\nUNITS=v,e\r\nEND\r\n',
 'char_w': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nEVENT=GRAPHEME\r\nCHAR=w\r\nUNITS=d,u,b,l,e,v,e\r\nEND\r\n',
 'char_x': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nEVENT=GRAPHEME\r\nCHAR=x\r\nUNITS=i,k,s\r\nEND\r\n',
 'char_y': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nEVENT=GRAPHEME\r\nCHAR=y\r\nUNITS=i,g,r,e,k\r\nEND\r\n',
 'char_z': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nEVENT=GRAPHEME\r\nCHAR=z\r\nUNITS=z,e,d\r\nEND\r\n',
 'text_ready': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nEVENT=SPELL_COMMIT\r\nSPELL_BUFFER=PASS\r\nBDL_RUNTIME_SPELL_SCHEDULE=PASS\r\nEND\r\n',
 'controller': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nHDA_CONTROLLER_CODEC=PASS\r\nEND\r\n',
 'topology': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nAFG_RUNTIME_DISCOVERY=PASS\r\nAUTO_DAC_WIDGET=PASS\r\nAUTO_OUTPUT_PIN_WIDGET=PASS\r\nAUTO_PIN_TO_DAC_DIRECT_ROUTE=PASS\r\nNO_FIXED_WIDGET_NIDS=PASS\r\nEND\r\n',
 'policy': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nPIN_CONFIG_DEFAULT=PASS\r\nPIN_CAPABILITIES_QUERY=PASS\r\nEAPD_IF_SUPPORTED=PASS\r\nDAC_OUTPUT_AMP_VERIFY=PASS\r\nEND\r\n',
 ...
 'alloc': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nSTATUS=BLOCKED\r\nREASON=DMA_ALLOC_FAILED\r\nEND\r\n',
 'verb': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nSTATUS=BLOCKED\r\nREASON=CODEC_VERB_FAILED\r\nEND\r\n',
 'stream_fail': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nSTATUS=BLOCKED\r\nREASON=STREAM_DMA_NO_PROGRESS\r\nEND\r\n',
 'key_fail': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nSTATUS=BLOCKED\r\nREASON=SPELL_INPUT_INVALID_OR_TOO_LONG\r\nEND\r\n',
 'topology_fail': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nSTATUS=BLOCKED\r\nREASON=AUTO_OUTPUT_ROUTE_DISCOVERY_FAILED\r\nEND\r\n',
 'policy_fail': b'QEVARYNOX-UEFI-HDA-SPELL-BUFFER-V1\r\nSTATUS=BLOCKED\r\nREASON=OUTPUT_POLICY_FAILED\r\nEND\r\n',
}
...
TEXT_UNITS=tuple(sorted({unit for sequence in LETTER_UNITS.values() for unit in sequence}))
...
def build():
 ...
 # Runtime spell input: append up to 8 Latin graphemes and construct
 # one or more HDA BDL descriptors per typed grapheme. Enter commits the spelling buffer.
 c.emit(b'\x31\xff\x31\xf6\x31\xdb')  # edi=graphemes, esi=total bytes, ebx=BDL entries; nonvolatile across EFI calls
 serial('wait')
 c.label('read_key')
 ...
 for char in LETTER_UNITS:
  c.emit(b'\x66\x3d'+struct.pack('<H',ord(char)))
  c.rel32(b'\x0f\x84','append_'+char)
 c.rel32(b'\xe9','fail_key')

 def emit_append(char,sequence):
  c.label('append_'+char)
  c.emit(b'\x83\xff\x08'); c.rel32(b'\x0f\x83','fail_key')
  serial('char_'+char)
  # textbuf[edi] = normalized UTF-16 grapheme
  c.lea_rdx_data(L['textbuf'])
  c.emit(b'\x89\xf8\x48\x8d\x04\x42')
  c.emit(b'\x66\xc7\x00'+struct.pack('<H',ord(char)))
  # Append one BDL descriptor per first-party unit in the letter name.
  for name in sequence:
   unit_off,unit_len=UNIT_LAYOUT[name]
   c.emit(b'\x83\xfb\x40'); c.rel32(b'\x0f\x83','fail_key')
 ...
 for char,sequence in LETTER_UNITS.items():
  emit_append(char,sequence)
 ...
 c.emit(b'\x89\xd8\xff\xc8\x48\xc1\xe0\x04\x4c\x01\xe8')
 c.emit(b'\xc7\x40\x0c\x01\x00\x00\x00')
 # Convert preserved (esi=total bytes, ebx=BDL entries) to the common (CBL,LVI) register contract.
 c.emit(b'\x89\xd8\xff\xc8')        # eax = BDL entry count-1
...
def main():
 if len(sys.argv)!=2: raise SystemExit('usage: build_uefi_hda_spell_buffer.py OUTPUT_EFI')
 image,pcm=build(); validate(image,pcm)
 p=Path(sys.argv[1]); p.parent.mkdir(parents=True,exist_ok=True); p.write_bytes(image)
 print('OS_UEFI_HDA_SPELL_BUFFER_BUILD=PASS')
 print('bytes='+str(len(image)))
 print('unit-bank-order='+','.join(UNIT_LAYOUT))
 print('runtime-spell-graphemes=A-Z,a-z')
 print('runtime-spell-max-graphemes=8')
 print('full-letter-name-pcm-assets=0')
