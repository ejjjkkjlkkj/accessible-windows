...
MARKS={
 'start': b'QEVARYNOX-UEFI-HDA-SPEECH-RUNTIME-V1\r\nSTATE=START\r\nSYNTH=ALLOPHONE_BDL_RUNTIME_V1\r\nWORD=AIDE\r\nUNITS=e,d\r\nTRANSPORT=HDA_NATIVE_DMA\r\nEND\r\n',
 'controller': b'QEVARYNOX-UEFI-HDA-SPEECH-RUNTIME-V1\r\nHDA_CONTROLLER_CODEC=PASS\r\nEND\r\n',
 'dma': b'QEVARYNOX-UEFI-HDA-SPEECH-RUNTIME-V1\r\nUNIT_BANK_COPY=PASS\r\nBDL_ALLOPHONE_SCHEDULE=PASS\r\nEND\r\n',
 'codec': b'QEVARYNOX-UEFI-HDA-SPEECH-RUNTIME-V1\r\nCODEC_DAC_STREAM=PASS\r\nCODEC_PIN_OUTPUT=PASS\r\nEND\r\n',
 'stream': b'QEVARYNOX-UEFI-HDA-SPEECH-RUNTIME-V1\r\nOUTPUT_STREAM_DESCRIPTOR=PASS\r\nFORMAT_48K_S16_STEREO=PASS\r\nBDL_ENTRIES=2\r\nEND\r\n',
 'progress': b'QEVARYNOX-UEFI-HDA-SPEECH-RUNTIME-V1\r\nLPIB_PROGRESS=PASS\r\nRUNTIME_ALLOPHONE_HDA=PASS\r\nEND\r\n',
 'done': b'QEVARYNOX-UEFI-HDA-SPEECH-RUNTIME-V1\r\nSTATUS=PASS\r\nEND\r\n',
 'no_hda': b'QEVARYNOX-UEFI-HDA-SPEECH-RUNTIME-V1\r\nSTATUS=BLOCKED\r\nREASON=HDA_PCI_NOT_FOUND\r\nEND\r\n',
 'bad_hda': b'QEVARYNOX-UEFI-HDA-SPEECH-RUNTIME-V1\r\nSTATUS=BLOCKED\r\nREASON=HDA_CONTROLLER_OR_CODEC_FAILED\r\nEND\r\n',
 'alloc': b'QEVARYNOX-UEFI-HDA-SPEECH-RUNTIME-V1\r\nSTATUS=BLOCKED\r\nREASON=DMA_ALLOC_FAILED\r\nEND\r\n',
 'verb': b'QEVARYNOX-UEFI-HDA-SPEECH-RUNTIME-V1\r\nSTATUS=BLOCKED\r\nREASON=CODEC_VERB_FAILED\r\nEND\r\n',
 'stream_fail': b'QEVARYNOX-UEFI-HDA-SPEECH-RUNTIME-V1\r\nSTATUS=BLOCKED\r\nREASON=STREAM_DMA_NO_PROGRESS\r\nEND\r\n',
}
...
def main():
 if len(sys.argv)!=2: raise SystemExit('usage: build_uefi_hda_speech_runtime.py OUTPUT_EFI')
 image,pcm=build(); validate(image,pcm)
 p=Path(sys.argv[1]); p.parent.mkdir(parents=True,exist_ok=True); p.write_bytes(image)
 print('OS_UEFI_HDA_SPEECH_RUNTIME_BUILD=PASS')
