...
MARKS={
 'start': b'QEVARYNOX-UEFI-HDA-INTERACTIVE-SPEECH-V1\r\nSTATE=START\r\nSYNTH=ALLOPHONE_BDL_RUNTIME_V1\r\nMODE=KEYBOARD_WORD_SELECT_AUTOROUTE\r\nTRANSPORT=HDA_NATIVE_DMA\r\nEND\r\n',
 'wait': b'QEVARYNOX-UEFI-HDA-INTERACTIVE-SPEECH-V1\r\nEVENT=WAIT_KEY\r\nKEY_1=AIDE\r\nKEY_2=ERREUR\r\nEND\r\n',
 'selected_aide': b'QEVARYNOX-UEFI-HDA-INTERACTIVE-SPEECH-V1\r\nEVENT=WORD_SELECTED\r\nWORD=AIDE\r\nUNITS=e,d\r\nEND\r\n',
 ...
 'progress': b'QEVARYNOX-UEFI-HDA-INTERACTIVE-SPEECH-V1\r\nLPIB_PROGRESS=PASS\r\nRUNTIME_WORD_SELECTION_HDA=PASS\r\nEND\r\n',
 'done': b'QEVARYNOX-UEFI-HDA-INTERACTIVE-SPEECH-V1\r\nSTATUS=PASS\r\nEND\r\n',
 'no_hda': b'QEVARYNOX-UEFI-HDA-INTERACTIVE-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=HDA_PCI_NOT_FOUND\r\nEND\r\n',
 'bad_hda': b'QEVARYNOX-UEFI-HDA-INTERACTIVE-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=HDA_CONTROLLER_OR_CODEC_FAILED\r\nEND\r\n',
 'alloc': b'QEVARYNOX-UEFI-HDA-INTERACTIVE-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=DMA_ALLOC_FAILED\r\nEND\r\n',
 'verb': b'QEVARYNOX-UEFI-HDA-INTERACTIVE-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=CODEC_VERB_FAILED\r\nEND\r\n',
 'stream_fail': b'QEVARYNOX-UEFI-HDA-INTERACTIVE-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=STREAM_DMA_NO_PROGRESS\r\nEND\r\n',
 'key_fail': b'QEVARYNOX-UEFI-HDA-INTERACTIVE-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=WORD_SELECTION_KEY_INVALID\r\nEND\r\n',
 'topology_fail': b'QEVARYNOX-UEFI-HDA-INTERACTIVE-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=AUTO_OUTPUT_ROUTE_DISCOVERY_FAILED\r\nEND\r\n',
 'policy_fail': b'QEVARYNOX-UEFI-HDA-INTERACTIVE-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=OUTPUT_POLICY_FAILED\r\nEND\r\n',
}
...
def main():
 if len(sys.argv)!=2: raise SystemExit('usage: build_uefi_hda_interactive_speech.py OUTPUT_EFI')
 image,pcm=build(); validate(image,pcm)
 p=Path(sys.argv[1]); p.parent.mkdir(parents=True,exist_ok=True); p.write_bytes(image)
 print('OS_UEFI_HDA_INTERACTIVE_SPEECH_BUILD=PASS')
