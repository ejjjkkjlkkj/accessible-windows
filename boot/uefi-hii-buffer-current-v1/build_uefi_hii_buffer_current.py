...
MARKS={
 'start': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nSTATE=START\r\nDOMAIN=PRE_OS_UEFI\r\nEND\r\n',
 'database': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nHII_DATABASE_PROTOCOL=PASS\r\nEND\r\n',
 'string_protocol': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nHII_STRING_PROTOCOL=PASS\r\nEND\r\n',
 'direct_export': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nHII_EXPORT_ALL_PACKAGE_LISTS=PASS\r\nEND\r\n',
 'forms_handle': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nHII_FORMS_HANDLE=LEGACY_NOT_USED\r\nEND\r\n',
 'strings_package': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nHII_STRINGS_PACKAGE=PASS\r\nEND\r\n',
 'strings_retry': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nHII_STRINGS_PACKAGE_RETRY=PASS\r\nEND\r\n',
 'first_handle': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nHII_FIRST_HANDLE_NONZERO=PASS\r\nEND\r\n',
 'static_empty': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_BUFFER_NOT_WRITTEN\r\nEND\r\n',
 'handle_export': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nHII_HANDLE_EXPORT=PASS\r\nEND\r\n',
 'export_size_ok': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nHII_HANDLE_EXPORT_SIZE=PASS\r\nEND\r\n',
 'export_size_invalid': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nHII_HANDLE_EXPORT_SIZE=EFI_INVALID_PARAMETER\r\nEND\r\n',
 'export_size_not_found': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nHII_HANDLE_EXPORT_SIZE=EFI_NOT_FOUND\r\nEND\r\n',
 'export_fetch_invalid': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nHII_HANDLE_EXPORT_FETCH=EFI_INVALID_PARAMETER\r\nEND\r\n',
 'export_fetch_not_found': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nHII_HANDLE_EXPORT_FETCH=EFI_NOT_FOUND\r\nEND\r\n',
 'forms_package_seen': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nHII_FORMS_PACKAGE=PASS\r\nEND\r\n',
 'ifr': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nIFR_QUESTION_PROMPT_STRING_ID=PASS\r\nEND\r\n',
 'language': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nHII_LANGUAGE=PASS\r\nEND\r\n',
 'prefix': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nQUESTION_TEXT=',
 'suffix': b'\r\nHII_QUESTION_STRING=PASS\r\nSTATUS=PASS\r\nEND\r\n',
 'meta_qid': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nQUESTION_ID_LE_HEX=',
 'meta_varstore': b'\r\nVARSTORE_ID_LE_HEX=',
 'meta_varinfo': b'\r\nVARSTORE_INFO_LE_HEX=',
 'meta_qflags': b'\r\nQUESTION_FLAGS_HEX=',
 'meta_oneof': b'\r\nONEOF_FLAGS_HEX=',
 'meta_done': b'\r\nQUESTION_METADATA=PASS\r\nEND\r\n',
 'vs_opcode': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nVARSTORE_OPCODE_HEX=',
 ...
 'no_protocol': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_PROTOCOL_NOT_FOUND\r\nEND\r\n',
 'list_size_fail': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_SIZE_QUERY_FAILED\r\nEND\r\n',
 'list_fetch_fail': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_FETCH_FAILED\r\nEND\r\n',
 'list_fetch_invalid': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_FETCH_EFI_INVALID_PARAMETER\r\nEND\r\n',
 'list_fetch_not_found': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_FETCH_EFI_NOT_FOUND\r\nEND\r\n',
 'list_fetch_bts_twice': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_FETCH_BUFFER_TOO_SMALL_TWICE\r\nEND\r\n',
 'list_static_small': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_STATIC_BUFFER_TOO_SMALL\r\nEND\r\n',
 'no_handle': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_FORMS_AND_STRINGS_PACKAGE_LIST_NOT_FOUND\r\nEND\r\n',
 'alloc': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nSTATUS=BLOCKED\r\nREASON=POOL_ALLOC_FAILED\r\nEND\r\n',
 'export': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_HANDLE_EXPORT_FAILED\r\nEND\r\n',
 'ifr_fail': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nSTATUS=BLOCKED\r\nREASON=IFR_QUESTION_TOKEN_NOT_FOUND\r\nEND\r\n',
 'lang_fail': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LANGUAGE_NOT_FOUND\r\nEND\r\n',
 'string_fail': b'QEVARYNOX-UEFI-HII-BUFFER-CURRENT-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_QUESTION_STRING_NOT_RESOLVED\r\nEND\r\n',
}
...
def build():
 ...
 c.emit(b'\x56'); c.rel32(b'\xe8','read_buffer_current'); c.emit(b'\x85\xc0\x5e'); c.rel32(b'\x0f\x85','prompt_next')
...
def main():
 if len(sys.argv)!=2: raise SystemExit('usage: build_uefi_hii_buffer_current.py OUTPUT_EFI')
 image=build(); validate(image)
 p=Path(sys.argv[1]); p.parent.mkdir(parents=True,exist_ok=True); p.write_bytes(image)
 print('OS_UEFI_HII_BUFFER_CURRENT_BUILD=PASS')
