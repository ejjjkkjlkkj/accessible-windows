...
MARKS={
 'start': b'QEVARYNOX-UEFI-HDA-TEXT26-V1\r\nSTATE=START\r\nSYNTH=ALLOPHONE_BDL_RUNTIME_V1\r\nMODE=RUNTIME_TEXT_AUTOROUTE\r\nTRANSPORT=HDA_NATIVE_DMA\r\nEND\r\n',
 'wait': b'QEVARYNOX-UEFI-HDA-TEXT26-V1\r\nEVENT=WAIT_TEXT\r\nSUPPORTED=a-z\r\nMAX_GRAPHEMES=8\r\nENTER=COMMIT\r\nEND\r\n',
 'char': b'QEVARYNOX-UEFI-HDA-TEXT26-V1\\r\\nEVENT=GRAPHEME_ACCEPTED\\r\\nEND\\r\\n',
 'text_ready': b'QEVARYNOX-UEFI-HDA-TEXT26-V1\r\nEVENT=TEXT_COMMIT\r\nTEXT_BUFFER=PASS\r\nBDL_RUNTIME_TEXT_SCHEDULE=PASS\r\nEND\r\n',
 'controller': b'QEVARYNOX-UEFI-HDA-TEXT26-V1\r\nHDA_CONTROLLER_CODEC=PASS\r\nEND\r\n',
 'topology': b'QEVARYNOX-UEFI-HDA-TEXT26-V1\r\nAFG_RUNTIME_DISCOVERY=PASS\r\nAUTO_DAC_WIDGET=PASS\r\nAUTO_OUTPUT_PIN_WIDGET=PASS\r\nAUTO_PIN_TO_DAC_DIRECT_ROUTE=PASS\r\nNO_FIXED_WIDGET_NIDS=PASS\r\nEND\r\n',
 'policy': b'QEVARYNOX-UEFI-HDA-TEXT26-V1\r\nPIN_CONFIG_DEFAULT=PASS\r\nPIN_CAPABILITIES_QUERY=PASS\r\nEAPD_IF_SUPPORTED=PASS\r\nDAC_OUTPUT_AMP_VERIFY=PASS\r\nEND\r\n',
 'dma': b'QEVARYNOX-UEFI-HDA-TEXT26-V1\r\nUNIT_BANK_COPY=PASS\r\nBDL_RUNTIME_TEXT_SCHEDULE=PASS\r\nEND\r\n',
 'codec': b'QEVARYNOX-UEFI-HDA-TEXT26-V1\r\nCODEC_DAC_STREAM=PASS\r\nCODEC_PIN_OUTPUT=PASS\r\nEND\r\n',
 'stream': b'QEVARYNOX-UEFI-HDA-TEXT26-V1\r\nOUTPUT_STREAM_DESCRIPTOR=PASS\r\nFORMAT_48K_S16_STEREO=PASS\r\nBDL_ENTRIES=RUNTIME\r\nEND\r\n',
 'progress': b'QEVARYNOX-UEFI-HDA-TEXT26-V1\r\nLPIB_PROGRESS=PASS\r\nRUNTIME_TEXT_HDA=PASS\r\nEND\r\n',
 'done': b'QEVARYNOX-UEFI-HDA-TEXT26-V1\r\nSTATUS=PASS\r\nEND\r\n',
 'no_hda': b'QEVARYNOX-UEFI-HDA-TEXT26-V1\r\nSTATUS=BLOCKED\r\nREASON=HDA_PCI_NOT_FOUND\r\nEND\r\n',
 'bad_hda': b'QEVARYNOX-UEFI-HDA-TEXT26-V1\r\nSTATUS=BLOCKED\r\nREASON=HDA_CONTROLLER_OR_CODEC_FAILED\r\nEND\r\n',
 'alloc': b'QEVARYNOX-UEFI-HDA-TEXT26-V1\r\nSTATUS=BLOCKED\r\nREASON=DMA_ALLOC_FAILED\r\nEND\r\n',
 'verb': b'QEVARYNOX-UEFI-HDA-TEXT26-V1\r\nSTATUS=BLOCKED\r\nREASON=CODEC_VERB_FAILED\r\nEND\r\n',
 'stream_fail': b'QEVARYNOX-UEFI-HDA-TEXT26-V1\r\nSTATUS=BLOCKED\r\nREASON=STREAM_DMA_NO_PROGRESS\r\nEND\r\n',
 'key_fail': b'QEVARYNOX-UEFI-HDA-TEXT26-V1\r\nSTATUS=BLOCKED\r\nREASON=TEXT_INPUT_INVALID_OR_TOO_LONG\r\nEND\r\n',
 'topology_fail': b'QEVARYNOX-UEFI-HDA-TEXT26-V1\r\nSTATUS=BLOCKED\r\nREASON=AUTO_OUTPUT_ROUTE_DISCOVERY_FAILED\r\nEND\r\n',
 'policy_fail': b'QEVARYNOX-UEFI-HDA-TEXT26-V1\r\nSTATUS=BLOCKED\r\nREASON=OUTPUT_POLICY_FAILED\r\nEND\r\n',
}
...
def build():
 ...
 # Runtime text input: append up to 8 Latin letters. Enter commits the
 # buffer, then expands every character into its first-party letter-name
 # allophone sequence and builds one HDA BDL descriptor per allophone.
 c.emit(bytes.fromhex('31ff'))  # edi = character count
 serial('wait')
 c.label('read_key')
 c.emit(bytes.fromhex('4889e9'))
 c.lea_rdx_data(L['keybuf'])
 c.emit(bytes.fromhex('488b4508ffd04885c0'))
 c.rel32(bytes.fromhex('0f85'),'read_key')
 c.lea_rdx_data(L['keybuf'])
 c.emit(bytes.fromhex('0fb74202'))
 c.emit(bytes.fromhex('6685c0')); c.rel32(bytes.fromhex('0f84'),'read_key')
 c.emit(bytes.fromhex('663d0d00')); c.rel32(bytes.fromhex('0f84'),'text_commit')
 c.emit(bytes.fromhex('6683c820'))  # ASCII uppercase -> lowercase
 for ch in LETTER_UNITS:
  c.emit(bytes.fromhex('663d')+struct.pack('<H',ord(ch)))
  c.rel32(bytes.fromhex('0f84'),'append_'+ch)
 c.rel32(bytes.fromhex('e9'),'fail_key')

 def emit_append(ch):
  c.label('append_'+ch)
  c.emit(bytes.fromhex('83ff08')); c.rel32(bytes.fromhex('0f83'),'fail_key')
  serial('char')
  ...
  c.rel32(bytes.fromhex('e9'),'read_key')
