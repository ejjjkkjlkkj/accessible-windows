...
MARKS={
 'start': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nSTATE=START\r\nSYNTH=ALLOPHONE_BDL_RUNTIME_V1\r\nMODE=HII_PROMPT_TO_HDA_SPEECH\r\nTRANSPORT=HDA_NATIVE_DMA\r\nEND\r\n',
 'wait': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nEVENT=HII_PROMPT_READY\r\nSUPPORTED=a-z\r\nMAX_SPOKEN_GRAPHEMES=8\r\nEND\r\n',
 'char': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nEVENT=HII_GRAPHEME_ACCEPTED\r\nEND\r\n',
 'text_ready': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nEVENT=HII_TEXT_COMMIT\r\nTEXT_BUFFER=PASS\r\nBDL_RUNTIME_TEXT_SCHEDULE=PASS\r\nEND\r\n',
 'database': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nHII_DATABASE_PROTOCOL=PASS\r\nEND\r\n',
 'string_protocol': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nHII_STRING_PROTOCOL=PASS\r\nEND\r\n',
 'direct_export': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nHII_EXPORT_ALL_PACKAGE_LISTS=PASS\r\nEND\r\n',
 'forms_package_seen': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nHII_FORMS_PACKAGE=PASS\r\nEND\r\n',
 'strings_package': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nHII_STRINGS_PACKAGE=PASS\r\nEND\r\n',
 'strings_retry': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nHII_STRINGS_PACKAGE_RETRY=PASS\r\nEND\r\n',
 'forms_handle': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nHII_FORMS_HANDLE=PASS\r\nEND\r\n',
 'ifr': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nIFR_PROMPT_STRING_ID=PASS\r\nEND\r\n',
 'language': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nHII_LANGUAGE=PASS\r\nEND\r\n',
 'hii': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nHII_PROMPT_SOURCE=PASS\r\nEND\r\n',
 'hii_protocol_fail': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_PROTOCOL_NOT_FOUND\r\nEND\r\n',
 'hii_list_size_fail': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_SIZE_QUERY_FAILED\r\nEND\r\n',
 'hii_list_fetch_fail': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_FETCH_FAILED\r\nEND\r\n',
 'hii_list_fetch_invalid': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_FETCH_EFI_INVALID_PARAMETER\r\nEND\r\n',
 'hii_list_fetch_not_found': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_FETCH_EFI_NOT_FOUND\r\nEND\r\n',
 'hii_list_static_small': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_STATIC_BUFFER_TOO_SMALL\r\nEND\r\n',
 'hii_handle_fail': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_FORMS_HANDLE_NOT_FOUND\r\nEND\r\n',
 'hii_alloc_fail': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_POOL_ALLOC_FAILED\r\nEND\r\n',
 'hii_export_fail': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_EXPORT_FAILED\r\nEND\r\n',
 'hii_ifr_fail': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=IFR_PROMPT_TOKEN_NOT_FOUND\r\nEND\r\n',
 'hii_language_fail': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LANGUAGE_NOT_FOUND\r\nEND\r\n',
 'hii_string_fail': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_PROMPT_STRING_NOT_RESOLVED\r\nEND\r\n',
 'controller': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nHDA_CONTROLLER_CODEC=PASS\r\nEND\r\n',
 'topology': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nAFG_RUNTIME_DISCOVERY=PASS\r\nAUTO_DAC_WIDGET=PASS\r\nAUTO_OUTPUT_PIN_WIDGET=PASS\r\nAUTO_PIN_TO_DAC_DIRECT_ROUTE=PASS\r\nNO_FIXED_WIDGET_NIDS=PASS\r\nEND\r\n',
 'policy': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nPIN_CONFIG_DEFAULT=PASS\r\nPIN_CAPABILITIES_QUERY=PASS\r\nEAPD_IF_SUPPORTED=PASS\r\nDAC_OUTPUT_AMP_VERIFY=PASS\r\nEND\r\n',
 'dma': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nUNIT_BANK_COPY=PASS\r\nBDL_RUNTIME_TEXT_SCHEDULE=PASS\r\nEND\r\n',
 'codec': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nCODEC_DAC_STREAM=PASS\r\nCODEC_PIN_OUTPUT=PASS\r\nEND\r\n',
 'stream': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nOUTPUT_STREAM_DESCRIPTOR=PASS\r\nFORMAT_48K_S16_STEREO=PASS\r\nBDL_ENTRIES=RUNTIME\r\nEND\r\n',
 'progress': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nLPIB_PROGRESS=PASS\r\nHII_PROMPT_SPEECH_HDA=PASS\r\nEND\r\n',
 'done': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nSTATUS=PASS\r\nEND\r\n',
 'controller_preferred': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nHDA_CONTROLLER_SELECTION=PREFERRED_AMD_1022_15E3\r\nEND\r\n',
 'controller_generic': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nHDA_CONTROLLER_SELECTION=GENERIC_CLASS_0403\r\nEND\r\n',
 'no_hda': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=HDA_PCI_NOT_FOUND\r\nEND\r\n',
 'bad_hda': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=HDA_CONTROLLER_OR_CODEC_FAILED\r\nEND\r\n',
 'alloc': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=DMA_ALLOC_FAILED\r\nEND\r\n',
 'verb': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=CODEC_VERB_FAILED\r\nEND\r\n',
 'stream_fail': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=STREAM_DMA_NO_PROGRESS\r\nEND\r\n',
 'key_fail': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=TEXT_INPUT_INVALID_OR_TOO_LONG\r\nEND\r\n',
 'topology_fail': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=AUTO_OUTPUT_ROUTE_DISCOVERY_FAILED\r\nEND\r\n',
 'policy_fail': b'QEVARYNOX-UEFI-HII-PROMPT-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=OUTPUT_POLICY_FAILED\r\nEND\r\n',
}
...
def build():
 ...
 L={'maxaddr':0,'keybuf':8,'dac_nid':16,'pin_nid':20,'textbuf':32,'text_count':56,'db_guid':64,'str_guid':80,'dbptr':96,'strptr':104,'handles_size':112,'handles_ptr':120,'pkg_size':128,'pkg_ptr':136,'langs_size':144,'langs_ptr':152,'string_size':160,'string_ptr':168,'token':176,'temp_handle':184,'handle_cursor':192,'handles_remaining':200,'forms_ptr':208,'strings_ptr':216,'list_len':224,'ifr_next_ptr':232,'ifr_next_remaining':240,'strings_first':248,'list_start':256,'global_remaining':264,'handles_static':0x100,'pkg_static':0x1100}
 ...
 # Keep the exact robust Prompt resolver policy: try sibling language packages,
 # then the next IFR prompt, then the next Forms+Strings package list.
 c.lea_rdx_data(L['strings_ptr']); c.emit(b'\x48\x8b\x32')
...
def main():
 if len(sys.argv)!=2: raise SystemExit('usage: build_uefi_hii_prompt_speech.py OUTPUT_EFI')
 image,pcm=build(); validate(image,pcm)
 p=Path(sys.argv[1]); p.parent.mkdir(parents=True,exist_ok=True); p.write_bytes(image)
 print('OS_UEFI_HII_PROMPT_SPEECH_BUILD=PASS')
 print('bytes='+str(len(image)))
 print('unit-bank-order='+','.join(UNIT_LAYOUT))
 print('hii-prompt-graphemes=a-z')
 print('hii-prompt-max-spoken-graphemes=8')
