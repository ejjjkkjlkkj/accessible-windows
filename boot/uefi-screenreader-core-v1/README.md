...
- Golden compatibility bridge covers all 13 prompt-bearing IFR opcode families from the validated firmware path.
- Golden key bridge preserves Up/Down, Home/End, PageUp/PageDown, F6/F7 role navigation, F8 Item Chooser, first-letter, repeat and exit semantics.
- Item Chooser cursor speech is generated by the V2 scheduler instead of the legacy fixed 64-character path.
