...
MARKS={
 'start': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nSTATE=START\r\nSYNTH=ALLOPHONE_BDL_RUNTIME_V1\r\nMODE=HII_OPTION_TO_HDA_SPEECH\r\nTRANSPORT=HDA_NATIVE_DMA\r\nEND\r\n',
 'wait': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nEVENT=HII_OPTION_READY\r\nSUPPORTED=a-z\r\nMAX_SPOKEN_GRAPHEMES=8\r\nEND\r\n',
 'char': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nEVENT=HII_GRAPHEME_ACCEPTED\r\nEND\r\n',
 'text_ready': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nEVENT=HII_TEXT_COMMIT\r\nTEXT_BUFFER=PASS\r\nBDL_RUNTIME_TEXT_SCHEDULE=PASS\r\nEND\r\n',
 'database': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nHII_DATABASE_PROTOCOL=PASS\r\nEND\r\n',
 'string_protocol': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nHII_STRING_PROTOCOL=PASS\r\nEND\r\n',
 'direct_export': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nHII_EXPORT_ALL_PACKAGE_LISTS=PASS\r\nEND\r\n',
 'forms_package_seen': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nHII_FORMS_PACKAGE=PASS\r\nEND\r\n',
 'strings_package': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nHII_STRINGS_PACKAGE=PASS\r\nEND\r\n',
 'strings_retry': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nHII_STRINGS_PACKAGE_RETRY=PASS\r\nEND\r\n',
 'forms_handle': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nHII_FORMS_HANDLE=PASS\r\nEND\r\n',
 'ifr': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nIFR_OPTION_STRING_ID=PASS\r\nEND\r\n',
 'language': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nHII_LANGUAGE=PASS\r\nEND\r\n',
 'hii': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nHII_OPTION_SOURCE=PASS\r\nEND\r\n',
 'hii_protocol_fail': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_PROTOCOL_NOT_FOUND\r\nEND\r\n',
 'hii_list_size_fail': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_SIZE_QUERY_FAILED\r\nEND\r\n',
 'hii_list_fetch_fail': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_FETCH_FAILED\r\nEND\r\n',
 'hii_list_fetch_invalid': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_FETCH_EFI_INVALID_PARAMETER\r\nEND\r\n',
 'hii_list_fetch_not_found': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_FETCH_EFI_NOT_FOUND\r\nEND\r\n',
 'hii_list_static_small': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_STATIC_BUFFER_TOO_SMALL\r\nEND\r\n',
 'hii_handle_fail': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_FORMS_HANDLE_NOT_FOUND\r\nEND\r\n',
 'hii_alloc_fail': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_POOL_ALLOC_FAILED\r\nEND\r\n',
 'hii_export_fail': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_EXPORT_FAILED\r\nEND\r\n',
 'hii_ifr_fail': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=IFR_OPTION_TOKEN_NOT_FOUND\r\nEND\r\n',
 'hii_language_fail': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LANGUAGE_NOT_FOUND\r\nEND\r\n',
 'hii_string_fail': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_OPTION_STRING_NOT_RESOLVED\r\nEND\r\n',
 'controller': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nHDA_CONTROLLER_CODEC=PASS\r\nEND\r\n',
 'topology': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nAFG_RUNTIME_DISCOVERY=PASS\r\nAUTO_DAC_WIDGET=PASS\r\nAUTO_OUTPUT_PIN_WIDGET=PASS\r\nAUTO_PIN_TO_DAC_DIRECT_ROUTE=PASS\r\nNO_FIXED_WIDGET_NIDS=PASS\r\nEND\r\n',
 'policy': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nPIN_CONFIG_DEFAULT=PASS\r\nPIN_CAPABILITIES_QUERY=PASS\r\nEAPD_IF_SUPPORTED=PASS\r\nDAC_OUTPUT_AMP_VERIFY=PASS\r\nEND\r\n',
 'dma': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nUNIT_BANK_COPY=PASS\r\nBDL_RUNTIME_TEXT_SCHEDULE=PASS\r\nEND\r\n',
 'codec': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nCODEC_DAC_STREAM=PASS\r\nCODEC_PIN_OUTPUT=PASS\r\nEND\r\n',
 ...
 'verb': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=CODEC_VERB_FAILED\r\nEND\r\n',
 'stream_fail': b'QEVARYNOX-UEFI-HII-OPTION-SPEECH-V1\r\nSTATUS=BLOCKED\r\nREASON=STREAM_DMA_NO_PROGRESS\r\nEND\r\n',
...
def build():
 ...
 c.label('ifr_loop')
 c.emit(b'\x41\x83\xfa\x02'); c.rel32(b'\x0f\x82','option_package_done')
 ...
 c.label('option_package_done'); c.rel32(b'\xe9','direct_list_next')
 ...
 c.emit(b'\x83\xf8\x04'); c.rel32(b'\x0f\x82','option_next')
 ...
 c.emit(b'\x48\x8d\x46\x04\x48\x39\xf8'); c.rel32(b'\x0f\x87','option_next')
 c.emit(b'\x8b\x06\x89\xc1\x81\xe1\xff\xff\xff\x00')
 c.emit(b'\x89\xc2\xc1\xea\x18')
 c.emit(b'\x83\xf9\x04'); c.rel32(b'\x0f\x82','option_next')
 c.emit(b'\x48\x8d\x04\x0e\x48\x39\xf8'); c.rel32(b'\x0f\x87','option_next')
 c.emit(b'\x83\xfa\x04'); c.rel32(b'\x0f\x84','use_next_strings')
 c.emit(b'\x81\xfa\xdf\x00\x00\x00'); c.rel32(b'\x0f\x84','option_next')
