...
MARKS={
 'start': b'QEVARYNOX-UEFI-HDA-VERB-V1\r\nSTATE=START\r\nTRANSPORT=IMMEDIATE_COMMAND\r\nEND\r\n',
 'hda': b'QEVARYNOX-UEFI-HDA-VERB-V1\r\nHDA_CONTROLLER_CODEC=PASS\r\nEND\r\n',
 'vendor': b'QEVARYNOX-UEFI-HDA-VERB-V1\r\nGET_PARAMETER_VENDOR_ID=PASS\r\nQEMU_CODEC_VENDOR_1AF4=PASS\r\nEND\r\n',
 'nodes': b'QEVARYNOX-UEFI-HDA-VERB-V1\r\nGET_PARAMETER_SUBORDINATE_NODES=PASS\r\nEND\r\n',
 'afg': b'QEVARYNOX-UEFI-HDA-VERB-V1\r\nGET_PARAMETER_FUNCTION_GROUP_TYPE=PASS\r\nAUDIO_FUNCTION_GROUP=PASS\r\nEND\r\n',
 'done': b'QEVARYNOX-UEFI-HDA-VERB-V1\r\nSTATUS=PASS\r\nEND\r\n',
 'no_hda': b'QEVARYNOX-UEFI-HDA-VERB-V1\r\nSTATUS=BLOCKED\r\nREASON=HDA_PCI_NOT_FOUND\r\nEND\r\n',
 'bad_hda': b'QEVARYNOX-UEFI-HDA-VERB-V1\r\nSTATUS=BLOCKED\r\nREASON=HDA_CONTROLLER_OR_CODEC_FAILED\r\nEND\r\n',
 'verb_timeout': b'QEVARYNOX-UEFI-HDA-VERB-V1\r\nSTATUS=BLOCKED\r\nREASON=IMMEDIATE_COMMAND_TIMEOUT\r\nEND\r\n',
 'vendor_fail': b'QEVARYNOX-UEFI-HDA-VERB-V1\r\nSTATUS=BLOCKED\r\nREASON=CODEC_VENDOR_UNEXPECTED\r\nEND\r\n',
 'nodes_fail': b'QEVARYNOX-UEFI-HDA-VERB-V1\r\nSTATUS=BLOCKED\r\nREASON=SUBORDINATE_NODES_INVALID\r\nEND\r\n',
 'afg_fail': b'QEVARYNOX-UEFI-HDA-VERB-V1\r\nSTATUS=BLOCKED\r\nREASON=AUDIO_FUNCTION_GROUP_NOT_FOUND\r\nEND\r\n',
}
...
def build():
 ...
 c.rel32(b'\xe8','immediate')
 c.emit(b'\x3d\xff\xff\xff\xff'); c.rel32(b'\x0f\x84','fail_verb_timeout')
 c.emit(b'\x84\xc0'); c.rel32(b'\x0f\x84','fail_nodes')
 ...
 c.emit(b'\x44\x89\xf1\xc1\xe1\x14\x09\xc8\x0d\x05\x00\x0f\x00')
 c.rel32(b'\xe8','immediate')
 c.emit(b'\x3d\xff\xff\xff\xff'); c.rel32(b'\x0f\x84','fail_verb_timeout')
 c.emit(b'\x25\xff\x00\x00\x00\x83\xf8\x01'); c.rel32(b'\x0f\x85','fail_afg')
 serial('afg'); serial('done')
 ...
 c.label('fail_afg'); serial('afg_fail')
...
def main():
 if len(sys.argv)!=2: raise SystemExit('usage: build_uefi_hda_verb_probe.py OUTPUT_EFI')
 image=build(); validate(image); p=Path(sys.argv[1]); p.parent.mkdir(parents=True,exist_ok=True); p.write_bytes(image)
 print('OS_UEFI_HDA_VERB_PROBE_BUILD=PASS'); print('bytes='+str(len(image))); print('sha256='+hashlib.sha256(image).hexdigest())
