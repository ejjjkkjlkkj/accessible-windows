...
MARKS={
 'start': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nSTATE=START\r\nDOMAIN=PRE_OS_UEFI\r\nEND\r\n',
 'database': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nHII_DATABASE_PROTOCOL=PASS\r\nEND\r\n',
 'string_protocol': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nHII_STRING_PROTOCOL=PASS\r\nEND\r\n',
 'direct_export': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nHII_EXPORT_ALL_PACKAGE_LISTS=PASS\r\nEND\r\n',
 'forms_handle': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nHII_FORMS_HANDLE=LEGACY_NOT_USED\r\nEND\r\n',
 'strings_package': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nHII_STRINGS_PACKAGE=PASS\r\nEND\r\n',
 'strings_retry': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nHII_STRINGS_PACKAGE_RETRY=PASS\r\nEND\r\n',
 'first_handle': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nHII_FIRST_HANDLE_NONZERO=PASS\r\nEND\r\n',
 'static_empty': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_BUFFER_NOT_WRITTEN\r\nEND\r\n',
 'handle_export': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nHII_HANDLE_EXPORT=PASS\r\nEND\r\n',
 'export_size_ok': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nHII_HANDLE_EXPORT_SIZE=PASS\r\nEND\r\n',
 'export_size_invalid': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nHII_HANDLE_EXPORT_SIZE=EFI_INVALID_PARAMETER\r\nEND\r\n',
 'export_size_not_found': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nHII_HANDLE_EXPORT_SIZE=EFI_NOT_FOUND\r\nEND\r\n',
 'export_fetch_invalid': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nHII_HANDLE_EXPORT_FETCH=EFI_INVALID_PARAMETER\r\nEND\r\n',
 'export_fetch_not_found': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nHII_HANDLE_EXPORT_FETCH=EFI_NOT_FOUND\r\nEND\r\n',
 'forms_package_seen': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nHII_FORMS_PACKAGE=PASS\r\nEND\r\n',
 'ifr': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nIFR_OPTION_STRING_ID=PASS\r\nEND\r\n',
 'language': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nHII_LANGUAGE=PASS\r\nEND\r\n',
 'prefix': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nOPTION_TEXT=',
 'suffix': b'\r\nHII_OPTION_STRING=PASS\r\nSTATUS=PASS\r\nEND\r\n',
 'meta_flags': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nOPTION_FLAGS_HEX=',
 'meta_type': b'\r\nOPTION_TYPE_HEX=',
 'meta_len': b'\r\nOPTION_VALUE_BYTES_HEX=',
 'meta_value': b'\r\nOPTION_VALUE_RAW8_HEX=',
 'meta_done': b'\r\nOPTION_METADATA=PASS\r\nEND\r\n',
 'no_protocol': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_PROTOCOL_NOT_FOUND\r\nEND\r\n',
 'list_size_fail': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_SIZE_QUERY_FAILED\r\nEND\r\n',
 'list_fetch_fail': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_FETCH_FAILED\r\nEND\r\n',
 'list_fetch_invalid': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_FETCH_EFI_INVALID_PARAMETER\r\nEND\r\n',
 'list_fetch_not_found': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_FETCH_EFI_NOT_FOUND\r\nEND\r\n',
 'list_fetch_bts_twice': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_FETCH_BUFFER_TOO_SMALL_TWICE\r\nEND\r\n',
 'list_static_small': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_STATIC_BUFFER_TOO_SMALL\r\nEND\r\n',
 'no_handle': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_FORMS_AND_STRINGS_PACKAGE_LIST_NOT_FOUND\r\nEND\r\n',
 'alloc': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nSTATUS=BLOCKED\r\nREASON=POOL_ALLOC_FAILED\r\nEND\r\n',
 'export': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_HANDLE_EXPORT_FAILED\r\nEND\r\n',
 'ifr_fail': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nSTATUS=BLOCKED\r\nREASON=IFR_OPTION_TOKEN_NOT_FOUND\r\nEND\r\n',
 'lang_fail': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LANGUAGE_NOT_FOUND\r\nEND\r\n',
 'string_fail': b'QEVARYNOX-UEFI-HII-OPTION-META-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_OPTION_STRING_NOT_RESOLVED\r\nEND\r\n',
}
...
def build():
 ...
 L={
  ...
  'option_flags':208,'option_type':209,'option_value_len':210,'option_raw':216,
 ...
 c.emit(b'\x3c\x09'); c.rel32(b'\x0f\x84','ifr_option')
 c.label('ifr_next')
 c.emit(b'\x49\x01\xc9\x41\x29\xca')
 c.rel32(b'\xe9','ifr_loop')

 c.label('ifr_option')
 # EFI_IFR_ONE_OF_OPTION: Header(2), Option StringId(2), Flags(1), Type(1), Value...
 c.emit(b'\x83\xf9\x06'); c.rel32(b'\x0f\x82','ifr_next')
 # Preserve opcode length while capturing its inline metadata.
 c.emit(b'\x51')
 ...
 c.emit(b'\x89\xc8\x83\xe8\x06\x83\xf8\x08'); c.rel32(b'\x0f\x86','option_meta_len_ok')
 c.emit(b'\xb8\x08\x00\x00\x00')
 c.label('option_meta_len_ok')
 c.lea_rdx_data(L['option_value_len']); c.emit(b'\x88\x02')
 c.lea_rdx_data(L['option_raw']); c.emit(b'\x48\xc7\x02\x00\x00\x00\x00\xc7\x42\x04\x00\x00\x00\x00')
 c.emit(b'\x49\x8d\x71\x06')
 c.lea_rdx_data(L['option_raw'])
 c.lea_rax_data(L['option_value_len']); c.emit(b'\x0f\xb6\x08')
 c.label('option_meta_copy')
 c.emit(b'\x85\xc9'); c.rel32(b'\x0f\x84','option_meta_copy_done')
 c.emit(b'\x8a\x06\x88\x02\x48\xff\xc6\x48\xff\xc2\xff\xc9')
 c.rel32(b'\xe9','option_meta_copy')
 c.label('option_meta_copy_done'); c.emit(b'\x59')
 ...
 # Start every Option candidate at the first language package; failures can
 ...
 # abandoning this Option StringId.
 c.lea_rdx_data(L['strings_ptr']); c.emit(b'\x48\x8b\x32')
 ...
 serial('meta_flags'); c.lea_rax_data(L['option_flags']); c.emit(b'\x8a\x00'); c.rel32(b'\xe8','hex8_emit')
 serial('meta_type'); c.lea_rax_data(L['option_type']); c.emit(b'\x8a\x00'); c.rel32(b'\xe8','hex8_emit')
 serial('meta_len'); c.lea_rax_data(L['option_value_len']); c.emit(b'\x8a\x00'); c.rel32(b'\xe8','hex8_emit')
 serial('meta_value')
 c.lea_rsi_data(L['option_raw']); c.emit(b'\xb9\x08\x00\x00\x00')
 c.label('meta_raw_loop'); c.emit(b'\x8a\x06'); c.rel32(b'\xe8','hex8_emit')
 c.emit(b'\x48\xff\xc6\xff\xc9'); c.rel32(b'\x0f\x85','meta_raw_loop')
...
def main():
 if len(sys.argv)!=2: raise SystemExit('usage: build_uefi_hii_option_meta.py OUTPUT_EFI')
 image=build(); validate(image)
 p=Path(sys.argv[1]); p.parent.mkdir(parents=True,exist_ok=True); p.write_bytes(image)
 print('OS_UEFI_HII_OPTION_META_BUILD=PASS')
