...
MARKS={
 'start': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nSTATE=START\r\nDOMAIN=PRE_OS_UEFI\r\nEND\r\n',
 'database': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nHII_DATABASE_PROTOCOL=PASS\r\nEND\r\n',
 'string_protocol': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nHII_STRING_PROTOCOL=PASS\r\nEND\r\n',
 'direct_export': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nHII_EXPORT_ALL_PACKAGE_LISTS=PASS\r\nEND\r\n',
 'forms_handle': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nHII_FORMS_HANDLE=LEGACY_NOT_USED\r\nEND\r\n',
 'strings_package': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nHII_STRINGS_PACKAGE=PASS\r\nEND\r\n',
 'strings_retry': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nHII_STRINGS_PACKAGE_RETRY=PASS\r\nEND\r\n',
 'first_handle': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nHII_FIRST_HANDLE_NONZERO=PASS\r\nEND\r\n',
 'static_empty': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_BUFFER_NOT_WRITTEN\r\nEND\r\n',
 'handle_export': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nHII_HANDLE_EXPORT=PASS\r\nEND\r\n',
 'export_size_ok': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nHII_HANDLE_EXPORT_SIZE=PASS\r\nEND\r\n',
 'export_size_invalid': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nHII_HANDLE_EXPORT_SIZE=EFI_INVALID_PARAMETER\r\nEND\r\n',
 'export_size_not_found': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nHII_HANDLE_EXPORT_SIZE=EFI_NOT_FOUND\r\nEND\r\n',
 'export_fetch_invalid': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nHII_HANDLE_EXPORT_FETCH=EFI_INVALID_PARAMETER\r\nEND\r\n',
 'export_fetch_not_found': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nHII_HANDLE_EXPORT_FETCH=EFI_NOT_FOUND\r\nEND\r\n',
 'forms_package_seen': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nHII_FORMS_PACKAGE=PASS\r\nEND\r\n',
 'ifr': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nIFR_QUESTION_PROMPT_STRING_ID=PASS\r\nEND\r\n',
 'language': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nHII_LANGUAGE=PASS\r\nEND\r\n',
 'prefix': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nQUESTION_TEXT=',
 'suffix': b'\r\nHII_QUESTION_STRING=PASS\r\nSTATUS=PASS\r\nEND\r\n',
 'meta_qid': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nQUESTION_ID_LE_HEX=',
 'meta_varstore': b'\r\nVARSTORE_ID_LE_HEX=',
 'meta_varinfo': b'\r\nVARSTORE_INFO_LE_HEX=',
 'meta_qflags': b'\r\nQUESTION_FLAGS_HEX=',
 'meta_oneof': b'\r\nONEOF_FLAGS_HEX=',
 'meta_done': b'\r\nQUESTION_METADATA=PASS\r\nEND\r\n',
 'vs_opcode': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nVARSTORE_OPCODE_HEX=',
 'vs_size': b'\r\nVARSTORE_SIZE_LE_HEX=',
 'vs_attrs': b'\r\nVARSTORE_ATTRIBUTES_LE_HEX=',
 'vs_guid': b'\r\nVARSTORE_GUID_RAW_HEX=',
 'vs_match': b'\r\nVARSTORE_DEFINITION_MATCH=PASS\r\nEND\r\n',
 'cur_width': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nCURRENT_VALUE_BYTES_HEX=',
 'cur_raw': b'\r\nCURRENT_VALUE_RAW8_HEX=',
 'cur_attrs': b'\r\nGET_VARIABLE_ATTRIBUTES_LE_HEX=',
 'cur_name': b'\r\nVARSTORE_EFI_NAME=',
 'cur_done': b'\r\nEFI_VARSTORE_EFI_MATCH=PASS\r\nGET_VARIABLE=PASS\r\nCURRENT_VALUE_READ=PASS\r\nEND\r\n',
 'no_protocol': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_PROTOCOL_NOT_FOUND\r\nEND\r\n',
 'list_size_fail': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_SIZE_QUERY_FAILED\r\nEND\r\n',
 'list_fetch_fail': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_FETCH_FAILED\r\nEND\r\n',
 'list_fetch_invalid': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_FETCH_EFI_INVALID_PARAMETER\r\nEND\r\n',
 'list_fetch_not_found': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_FETCH_EFI_NOT_FOUND\r\nEND\r\n',
 'list_fetch_bts_twice': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_FETCH_BUFFER_TOO_SMALL_TWICE\r\nEND\r\n',
 'list_static_small': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LIST_STATIC_BUFFER_TOO_SMALL\r\nEND\r\n',
 'no_handle': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_FORMS_AND_STRINGS_PACKAGE_LIST_NOT_FOUND\r\nEND\r\n',
 'alloc': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nSTATUS=BLOCKED\r\nREASON=POOL_ALLOC_FAILED\r\nEND\r\n',
 'export': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_HANDLE_EXPORT_FAILED\r\nEND\r\n',
 'ifr_fail': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nSTATUS=BLOCKED\r\nREASON=IFR_QUESTION_TOKEN_NOT_FOUND\r\nEND\r\n',
 'lang_fail': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_LANGUAGE_NOT_FOUND\r\nEND\r\n',
 'string_fail': b'QEVARYNOX-UEFI-HII-EFI-VAR-CURRENT-V1\r\nSTATUS=BLOCKED\r\nREASON=HII_QUESTION_STRING_NOT_RESOLVED\r\nEND\r\n',
}
...
def build():
 ...
 L={
  ...
  'runtime_ptr':240,'varstore_op_ptr':248,'current_data_size':256,'current_attrs':264,
  'current_width':268,'current_raw':272,
  'varname_utf16':0x300,'handles_static':0x500,'pkg_static':0x1500,
  'current_data':0x101500,
 }
 ...
 # Preserve EFI_SYSTEM_TABLE.RuntimeServices before rdx becomes scratch.
 c.emit(b'\x48\x8b\x42\x58')
 c.emit(b'\x48\x83\xec\x68\xfc')
 c.lea_rdx_data(L['runtime_ptr']); c.emit(b'\x48\x89\x02')
 ...
 c.emit(b'\x56'); c.rel32(b'\xe8','resolve_varstore'); c.emit(b'\x85\xc0\x5e'); c.rel32(b'\x0f\x85','prompt_next')
 c.emit(b'\x56'); c.rel32(b'\xe8','read_current_efi_var'); c.emit(b'\x85\xc0\x5e'); c.rel32(b'\x0f\x85','prompt_next')
 c.emit(b'\x56'); c.rel32(b'\xe8','emit_question_meta'); c.rel32(b'\xe8','emit_varstore_meta'); c.rel32(b'\xe8','emit_current_meta'); c.emit(b'\x5e')
 ...
 c.label('varstore_found')
 c.lea_rdx_data(L['varstore_op_ptr']); c.emit(b'\x4c\x89\x0a')
 c.emit(b'\x31\xc0\xc3')
 c.label('varstore_not_found'); c.emit(b'\xb8\x01\x00\x00\x00\xc3')

 c.label('read_current_efi_var')
 # Only EFI_IFR_VARSTORE_EFI (0x26) is read through RuntimeServices.GetVariable.
 # Buffer (0x24) and name/value (0x25) stores require ConfigAccess instead.
 c.lea_rax_data(L['varstore_opcode']); c.emit(b'\x80\x38\x26'); c.rel32(b'\x0f\x85','current_not_found')
 c.lea_rdx_data(L['varstore_op_ptr']); c.emit(b'\x48\x8b\x32')
 c.emit(b'\x48\x85\xf6'); c.rel32(b'\x0f\x84','current_not_found')
 # Validate opcode length and convert its trailing ASCII Name to CHAR16.
 c.emit(b'\x0f\xb6\x4e\x01\x83\xe1\x7f\x83\xf9\x1b'); c.rel32(b'\x0f\x82','current_not_found')
 c.emit(b'\x48\x83\xc6\x1a\x83\xe9\x1a')
 c.lea_rdi_data(L['varname_utf16'])
 c.label('current_name_loop')
 c.emit(b'\x85\xc9'); c.rel32(b'\x0f\x84','current_not_found')
 c.emit(b'\x0f\xb6\x06\x48\xff\xc6\xff\xc9\x66\x89\x07\x48\x83\xc7\x02')
 c.emit(b'\x84\xc0'); c.rel32(b'\x0f\x85','current_name_loop')

 # ONE_OF numeric size bits: 0/1/2/3 => 1/2/4/8 bytes.
 ...
 # Validate VarOffset + width against the declared EFI variable store size.
 c.lea_rdx_data(L['varstore_info']); c.emit(b'\x0f\xb7\x12\x01\xc2')
 c.lea_rax_data(L['varstore_size']); c.emit(b'\x0f\xb7\x00\x39\xc2'); c.rel32(b'\x0f\x87','current_not_found')
 # This stage uses a bounded 64 KiB read buffer.
 c.emit(b'\x3d\x00\x00\x01\x00'); c.rel32(b'\x0f\x87','current_not_found')
 c.lea_rdx_data(L['current_data_size']); c.emit(b'\x48\x89\x02')
 c.lea_rdx_data(L['current_attrs']); c.emit(b'\xc7\x02\x00\x00\x00\x00')

 # EFI_STATUS GetVariable(Name, Guid, &Attributes, &DataSize, Data)
 c.lea_rcx_data(L['varname_utf16'])
 c.lea_rdx_data(L['varstore_guid'])
 c.lea_r8_data(L['current_attrs'])
 c.lea_r9_data(L['current_data_size'])
 c.lea_rax_data(L['current_data']); c.emit(b'\x48\x89\x44\x24\x20')
 c.lea_rax_data(L['runtime_ptr']); c.emit(b'\x48\x8b\x00')
 c.emit(b'\x48\x85\xc0'); c.rel32(b'\x0f\x84','current_not_found')
 c.emit(b'\xff\x50\x48')
 c.emit(b'\x48\x85\xc0'); c.rel32(b'\x0f\x85','current_not_found')

 # Revalidate returned DataSize and copy only the question field.
 c.lea_rax_data(L['current_data_size']); c.emit(b'\x48\x8b\x00')
 c.lea_rdx_data(L['varstore_info']); c.emit(b'\x0f\xb7\x12')
 c.lea_rcx_data(L['current_width']); c.emit(b'\x0f\xb6\x09\x48\x01\xca')
 c.emit(b'\x48\x39\xd0'); c.rel32(b'\x0f\x82','current_not_found')
 c.lea_rsi_data(L['current_data'])
 c.lea_rax_data(L['varstore_info']); c.emit(b'\x0f\xb7\x00\x48\x01\xc6')
 ...
 c.label('current_copy_loop')
 c.emit(b'\x85\xc9'); c.rel32(b'\x0f\x84','current_read_ok')
 c.emit(b'\x8a\x06\x88\x02\x48\xff\xc6\x48\xff\xc2\xff\xc9'); c.rel32(b'\xe9','current_copy_loop')
 c.label('current_read_ok'); c.emit(b'\x31\xc0\xc3')
 c.label('current_not_found'); c.emit(b'\xb8\x01\x00\x00\x00\xc3')
 ...
 c.label('cur_raw_loop'); c.emit(b'\x8a\x06'); c.rel32(b'\xe8','hex8_emit'); c.emit(b'\x48\xff\xc6\xff\xc9'); c.rel32(b'\x0f\x85','cur_raw_loop')
 serial('cur_attrs'); c.lea_rsi_data(L['current_attrs']); c.emit(b'\xb9\x04\x00\x00\x00')
 c.label('cur_attrs_loop'); c.emit(b'\x8a\x06'); c.rel32(b'\xe8','hex8_emit'); c.emit(b'\x48\xff\xc6\xff\xc9'); c.rel32(b'\x0f\x85','cur_attrs_loop')
 serial('cur_name'); c.lea_rsi_data(L['varname_utf16']); c.rel32(b'\xe8','serial_utf16')
...
def main():
 if len(sys.argv)!=2: raise SystemExit('usage: build_uefi_hii_efi_var_current.py OUTPUT_EFI')
 image=build(); validate(image)
 p=Path(sys.argv[1]); p.parent.mkdir(parents=True,exist_ok=True); p.write_bytes(image)
 print('OS_UEFI_HII_EFI_VAR_CURRENT_BUILD=PASS')
